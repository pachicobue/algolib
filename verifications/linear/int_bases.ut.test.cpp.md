...
data:
  ...
  verifiedWith: []
documentation_of: verifications/linear/int_bases.ut.test.cpp
layout: document
redirect_from:
- /verify/verifications/linear/int_bases.ut.test.cpp
- /verify/verifications/linear/int_bases.ut.test.cpp.html
