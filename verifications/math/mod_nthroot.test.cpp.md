...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    \ std::enable_if_t<mod_ != 0, U> mod()\n    {\n        return mod_;\n    }\n \
    \   template<typename U = const u32>\n    static std::enable_if_t<mod_ == 0, U>\
    \ mod()\n    {\n        return modRef();\n    }\n    template<typename U = const\
    \ u32>\n    static constexpr std::enable_if_t<mod_ != 0, U> root()\n    {\n  \
    \      return root_;\n    }\n    template<typename U = const u32>\n    static\
    \ std::enable_if_t<mod_ == 0, U> root()\n    {\n        return rootRef();\n  \
    ...
    \    for (int t : rep(T)) {\n        const auto [K, Y, P] = in.tup<uint, uint,\
    \ uint>();\n        if (P == 2) {\n            out.ln(Y == 1 ? 1 : K == 0 ? -1\
    \ : 0);\n            continue;\n        }\n        mint::setMod(P);\n        const\
    \ mint ans = modNthRoot(mint{Y}, K);\n        if (ans.pow(K) == Y) {\n       \
    \     out.ln(ans.val());\n        } else {\n            out.ln(-1);\n        }\n\
    \    }\n    return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/verifications/math/mod_nthroot.test.cpp
- /verify/verifications/math/mod_nthroot.test.cpp.html
