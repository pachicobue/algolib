...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#include <iostream>\nusing i32 = int;\n\
    ...
    \ 0, id>;\ntemplate<typename T>\nVec<T> setHadamard(const Vec<T>& xs, bool rev\
    ...
    \ {\n        const T iN = T{1} / N;\n        for (auto& y : ys) {\n          \
    \  y *= iN;\n        }\n    }\n    return ys;\n}\ntemplate<typename T>\nVec<T>\
    \ xorConvolute(Vec<T> f, Vec<T> g)\n{\n    const int N = ceil2(std::max(f.size(),\
    \ g.size()));\n    f.resize(N), g.resize(N);\n    auto F = setHadamard(f, false),\
    \ G = setHadamard(g, false);\n    for (int i : rep(N)) {\n        F[i] *= G[i];\n\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/bitwise_xor_convolution\"\
    \n#include \"../../src/math/modint.hpp\"\n#include \"../../src/math/xor_convolution.hpp\"\
...
layout: document
redirect_from:
- /verify/verifications/math/xor_convolution.test.cpp
- /verify/verifications/math/xor_convolution.test.cpp.html
