...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    class DSU\n{\npublic:\n    DSU(int n) : m_v{n}, m_roots{iotaVec(n)}, m_sizes(m_v,\
    \ 0) {}\n    int root(int i)\n    {\n        if (m_roots[i] == i) {\n        \
...
layout: document
redirect_from:
- /verify/verifications/data_structure/unionfind.test.cpp
- /verify/verifications/data_structure/unionfind.test.cpp.html
