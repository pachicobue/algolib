...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \ {\n                sum += m_vs[x + k], x += k;\n            }\n        }\n \
    \       return x;\n    }\n    friend Ostream& operator<<(Ostream& os, const Fenwick&\
    \ fw)\n    {\n        os << \"[\";\n        for (int i : rep(fw.m_size)) {\n \
    \           os << (i == 0 ? \"\" : \",\") << fw.sum(i, i + 1);\n        }\n  \
    \      return (os << \"]\\n\");\n    }\nprivate:\n    int m_size, m_cap;\n   \
    \ Vec<T> m_vs;\n};\nvoid Test()\n{\n    Fenwick<int> fenwick({1, 2, 3, 4, 5, 6,\
    \ 7});\n    assert(fenwick.maxRight([](int s) { return s <= 0; }) == 0);\n   \
    \ assert(fenwick.maxRight([](int s) { return s <= 1; }) == 1);\n    assert(fenwick.maxRight([](int\
    \ s) { return s <= 3; }) == 2);\n    assert(fenwick.maxRight([](int s) { return\
    \ s <= 21; }) == 6);\n    assert(fenwick.maxRight([](int s) { return s <= 30;\
    \ }) == 7);\n    std::cerr << fenwick << std::endl;\n}\nint main()\n{\n    Test();\n\
    \    std::cout << \"Hello World\\n\";\n    return 0;\n}\n"
  code: "#define PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    \n#include \"../../src/data_structure/fenwick.hpp\"\n\nvoid Test()\n{\n    Fenwick<int>\
    \ fenwick({1, 2, 3, 4, 5, 6, 7});\n    assert(fenwick.maxRight([](int s) { return\
    \ s <= 0; }) == 0);\n    assert(fenwick.maxRight([](int s) { return s <= 1; })\
  ...
  verifiedWith: []
documentation_of: verifications/data_structure/fenwick.max_right.test.cpp
layout: document
redirect_from:
- /verify/verifications/data_structure/fenwick.max_right.test.cpp
- /verify/verifications/data_structure/fenwick.max_right.test.cpp.html
