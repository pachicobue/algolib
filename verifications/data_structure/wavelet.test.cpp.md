...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \                ans += zr - zl;\n                l += z - zl, r += z - zr;\n\
    \            } else {\n                l = zl, r = zr;\n            }\n      \
    \  }\n        return ans;\n    }\n    int rangeFreq(int l, int r, u64 vmin, u64\
    ...
    \ - zr, n -= (zr - zl);\n            } else {\n                l = zl, r = zr;\n\
    \            }\n        }\n        return ans;\n    }\nprivate:\n    static constexpr\
    \ int bucket_size = sizeof(u64) * 8;\n    static constexpr int bslog = log2p1(bucket_size)\
...
layout: document
redirect_from:
- /verify/verifications/data_structure/wavelet.test.cpp
- /verify/verifications/data_structure/wavelet.test.cpp.html
