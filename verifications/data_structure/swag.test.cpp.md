...
data:
  ...
  bundledCode: "#include <iostream>\n#include <bits/stdc++.h>\n#pragma region Macros\n\
    ...
    \ typename SemiGroup::T;\npublic:\n    SWAG() : m_merge{} {}\n    void pushBack(const\
    \ T& x)\n    {\n        m_backs.push_back(x);\n        m_Backs.push_back(m_Backs.empty()\
    \ ? x : m_merge(m_Backs.back(), x));\n    }\n    void pushFront(const T& x)\n\
    \    {\n        m_fronts.push_back(x);\n        m_Fronts.push_back(m_Fronts.empty()\
    \ ? x : m_merge(x, m_Fronts.back()));\n    }\n    void popBack()\n    {\n    \
    \    if (m_Backs.empty()) {\n            Vec<T> as = m_fronts;\n            m_fronts.clear(),\
    \ m_Fronts.clear();\n            reverseAll(as);\n            const int f = (int)as.size()\
...
layout: document
redirect_from:
- /verify/verifications/data_structure/swag.test.cpp
- /verify/verifications/data_structure/swag.test.cpp.html
