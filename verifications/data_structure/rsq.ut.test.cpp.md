...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    \ T>\nclass RSQ\n{\npublic:\n    RSQ(const Vec<T>& vs)\n        : m_size(vs.size()),\n\
    \          m_vs(vs),\n          m_prefs(vs.size() + 1, T{}),\n          m_suffs(vs.size()\
    \ + 1, T{})\n    {\n        std::copy(vs.begin(), vs.end(), m_prefs.begin() +\
  ...
  verifiedWith: []
documentation_of: verifications/data_structure/rsq.ut.test.cpp
layout: document
redirect_from:
- /verify/verifications/data_structure/rsq.ut.test.cpp
- /verify/verifications/data_structure/rsq.ut.test.cpp.html
