...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    Hello World\\n\";\n    return 0;\n}\n"
  code: "#define PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    \n#include \"../../src/ds/fenwick.hpp\"\n\nvoid Test()\n{\n    Fenwick<int> fenwick({1,\
    \ 2, 3, 4, 5, 6, 7});\n    assert(fenwick.maxRight([](int s) { return s <= 0;\
  ...
  verifiedWith: []
documentation_of: verifications/ds/fenwick.max_right.test.cpp
layout: document
redirect_from:
- /verify/verifications/ds/fenwick.max_right.test.cpp
- /verify/verifications/ds/fenwick.max_right.test.cpp.html
