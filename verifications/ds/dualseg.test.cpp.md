...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    \   for (; li < ri; li >>= 1, ri >>= 1) {\n            if (li & 1) { update(li++,\
    \ f); }\n            if (ri & 1) { update(--ri, f); }\n        }\n    }\n    friend\
    \ Ostream& operator<<(Ostream& os, const DualSeg& seg)\n    {\n        os << \"\
  ...
  verifiedWith: []
documentation_of: verifications/ds/dualseg.test.cpp
layout: document
redirect_from:
- /verify/verifications/ds/dualseg.test.cpp
- /verify/verifications/ds/dualseg.test.cpp.html
