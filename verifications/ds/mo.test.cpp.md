...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    \ == 0 ? \"\" : \",\") << fw.sum(i, i + 1);\n        }\n        return (os <<\
    \ \"]\\n\");\n    }\nprivate:\n    int m_size, m_cap;\n    Vec<T> m_vs;\n};\n\
    template<int block_size>\nclass Mo\n{\npublic:\n    Mo(const Vec<int>& xs, const\
    \ Vec<int>& ys)\n        : m_xs{xs}, m_ys{ys}, m_is{iotaVec(m_xs.size())}\n  \
    \  {\n        sortAll(m_is, [&](int i, int j) {\n            const int ib = m_xs[i]\
    \ / block_size;\n            const int jb = m_xs[j] / block_size;\n          \
    \  return ib != jb ? ib < jb\n                            : (ib % 2 ? m_ys[j]\
    \ < m_ys[i] : m_ys[i] < m_ys[j]);\n        });\n    }\n    template<typename R,\
    \ typename L, typename D, typename U>\n    int next(R right, L left, D down, U\
    ...
    \ c == EOF) { break; }\n        ans.push_back(c);\n    }\n    return ans;\n}\n\
    template<typename T>\nclass Zipper\n{\npublic:\n    Zipper() {}\n    Zipper(const\
    \ Vec<T>& vs) : m_vs(vs), m_calced(false) {}\n    T unzip(int n)\n    {\n    \
  ...
  verifiedWith: []
documentation_of: verifications/ds/mo.test.cpp
layout: document
redirect_from:
- /verify/verifications/ds/mo.test.cpp
- /verify/verifications/ds/mo.test.cpp.html
