...
data:
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\n#include \"\
    ...
    \ auto rmq = DisjointSparseTable<SemiGroup>(as);\n    for (int q : rep(Q)) {\n\
  ...
  verifiedWith: []
documentation_of: verifications/ds/ds_table.test.cpp
layout: document
redirect_from:
- /verify/verifications/ds/ds_table.test.cpp
- /verify/verifications/ds/ds_table.test.cpp.html
