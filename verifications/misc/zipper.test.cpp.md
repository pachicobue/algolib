...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    \ T>\nclass Zipper\n{\npublic:\n    Zipper() {}\n    Zipper(const Vec<T>& vs)\
    \ : m_vs(vs), m_calced(false) {}\n    T unzip(int n)\n    {\n        assert(0\
    \ <= n and n < (int)m_vs.size());\n        calc();\n        return m_vs[n];\n\
    \    }\n    int zip(T v)\n    {\n        calc();\n        return lbInd(m_vs, v);\n\
    \    }\n    void add(T v)\n    {\n        m_vs.push_back(v);\n        m_calced\
    ...
    \    zipper.add({2, 4, 2, 6, 6, 2});\n    assert(zipper.unzip(0) == 2);\n    assert(zipper.unzip(1)\
    \ == 4);\n    assert(zipper.unzip(2) == 6);\n    assert(zipper.zip(2) == 0);\n\
  ...
  verifiedWith: []
documentation_of: verifications/misc/zipper.test.cpp
layout: document
redirect_from:
- /verify/verifications/misc/zipper.test.cpp
- /verify/verifications/misc/zipper.test.cpp.html
