...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    \    for (int i : rep(M)) {\n        static_cast<void>(i);\n        const auto\
    \ [a, b] = in.tup<int, int>();\n        g.addEdge(a, b, true);\n    }\n    const\
    \ auto tecc = TwoEdgeConnectedComponent(g);\n    const int C = tecc.cnum();\n\
  ...
  verifiedWith: []
documentation_of: verifications/graph/tecc.test.cpp
layout: document
redirect_from:
- /verify/verifications/graph/tecc.test.cpp
- /verify/verifications/graph/tecc.test.cpp.html
