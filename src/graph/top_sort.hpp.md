...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \ Vec<int>> topSort(const Graph<T>& g)\n{\n    const int N = g.v();\n    Vec<int>\
    \ ans;\n    Vec<int> used(N, 0);\n    auto dfs = Fixpoint([&](auto dfs, int s)\
    \ -> bool {\n        if (used[s] == 1) {\n            return false;\n        }\
    \ else if (used[s] == 0) {\n            used[s] = 1;\n            for (int to\
...
documentation_of: src/graph/top_sort.hpp
layout: document
redirect_from:
- /library/src/graph/top_sort.hpp
- /library/src/graph/top_sort.hpp.html
