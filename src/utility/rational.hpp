...
public:
     ...
     * @return Rational -x
     */
    constexpr friend auto operator-(const Rational& x) -> Rational { return {-x.m_num, x.m_den}; }
    /**
     * @brief x1 <- x1+x2
     *
     * @param x1
     ...
     * @return false 不一致
     */
    constexpr friend auto operator==(const Rational& x1, const Rational& x2) -> bool { return x1.m_num == x2.m_num and x1.m_den == x2.m_den; }
    /**
     * @brief x1<=>x2
     *
     * @param x1
     ...
     */
    constexpr auto val() const -> Pair<T, T> { return {m_num, m_den}; }
    /**
     * @brief 分子
     *
     * @return T 分子
     */
    constexpr auto num() const -> T { return m_num; }
    /**
     * @brief 分母
     *
     * @return T 分母
     */
    constexpr auto den() const -> T { return m_den; }
#ifdef HOGEPACHI
