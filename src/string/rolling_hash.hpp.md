...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\nusing i32 = int;\nusing u32 = unsigned int;\n\
    ...
    {\npublic:\n    template<typename It>\n    RollingHash(It first, It last, u64\
    \ base_ = rng64.val<u64>(2, mask61 - 1))\n        : m_size(std::distance(first,\
    \ last)),\n          m_ps(m_size + 1, 1),\n          m_hs(m_size + 1, 0),\n  \
    \        m_base{base_}\n    {\n        for (int i : range(1, m_size + 1)) {\n\
    \            m_ps[i] = mod(mul(m_ps[i - 1], m_base)),\n            m_hs[i] = mod(mul(m_hs[i\
    \ - 1], m_base) + *std::next(first, i - 1));\n        }\n    }\n    u64 operator()(int\
    \ l, int r) const\n    {\n        return mod(m_hs[r] + offset - mul(m_hs[l], m_ps[r\
    \ - l]));\n    }\n    template<typename C>\n    void push_back(C c)\n    {\n \
    ...
    \ mask31 = (1_u64 << 31) - 1;\n    static constexpr u64 mask61 = (1_u64 << 61)\
