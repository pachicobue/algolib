...
data:
  ...
  code: "#pragma once\n#include \"../misc/common.hpp\"\ntemplate<typename It>\nVec<int>\
    \ suffixArray(It first, It last, int vsup = 256)\n{\n    const int N = last -\
    \ first;\n    Vec<int> vs(N);\n    std::copy(first, last, vs.begin());\n    for\
    \ (auto& v : vs) {\n        assert(0 <= v and v < vsup);\n        v++;\n    }\n\
    \    vs.push_back(0);\n    Vec<bool> is_l(N + 1, false);\n    Vec<bool> is_lms(N\
    \ + 1, false);\n}\n\n// template<typename It>\n// Vec<int> suffixArray(It first,\
    \ It last, int bucket_size = (1UL << 8))\n// {\n//     bucket_size++;\n//    \
    ...
    \ = ind;\n//         }\n//     } else {\n//         for (int k : rep(bucket_size))\
    \ {\n//             spos[k] = lpos[k] = 0;\n//         }\n//         for (auto\
    \ it = lms.rbegin(); it < lms.rend(); it++) {\n//             sBucket[S[*it]][spos[S[*it]]++]\
    \ = *it;\n//         }\n//     }\n//     induce();\n//     Vec<int> ans;\n// \
