...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \    using Tp = SysClock::time_point;\npublic:\n    StopWatch() : m_start{SysClock::now()},\
    ...
    \ const auto now = SysClock::now();\n        return std::chrono::duration_cast<D>(now\
  ...
  verifiedWith: []
documentation_of: src/misc/stopwatch.hpp
layout: document
redirect_from:
- /library/src/misc/stopwatch.hpp
- /library/src/misc/stopwatch.hpp.html
