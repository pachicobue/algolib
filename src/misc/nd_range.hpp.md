...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \ end() const\n    {\n        return itr{m_ns};\n    }\n};\n#pragma endregion\n"
  code: "#pragma once\n#include \"common.hpp\"\n#pragma region NdRange\nclass ndRep\n\
    {\nprivate:\n    struct itr\n    {\n        itr(const Vec<int>& ns) : m_ns{ns},\
    \ m_cs(ns.size(), 0), m_end{false} {}\n        bool operator!=(const itr&) const\n\
    \        {\n            return not m_end;\n        }\n        const Vec<int>&\
    \ operator*()\n        {\n            return m_cs;\n        }\n        itr& operator++()\n\
    \        {\n            for (const int i : per(m_ns.size())) {\n             \
    \   m_cs[i]++;\n                if (m_cs[i] < m_ns[i]) {\n                   \
...
documentation_of: src/misc/nd_range.hpp
layout: document
redirect_from:
- /library/src/misc/nd_range.hpp
- /library/src/misc/nd_range.hpp.html
