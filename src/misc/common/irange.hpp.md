...
data:
  ...
  code: "#pragma once\n#include \"type_alias.hpp\"\nclass irange\n{\nprivate:\n  \
    \  struct itr\n    {\n        itr(i64 start = 0, i64 step = 1) : m_cnt{start},\
    \ m_step{step} {}\n        bool operator!=(const itr& it) const\n        {\n \
...
documentation_of: src/misc/common/irange.hpp
layout: document
redirect_from:
- /library/src/misc/common/irange.hpp
- /library/src/misc/common/irange.hpp.html
