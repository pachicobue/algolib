...
data:
  ...
  code: "#pragma once\n#include \"type_alias.hpp\"\ntemplate<typename T>\nconstexpr\
    \ T LIMMIN = std::numeric_limits<T>::min();\ntemplate<typename T>\nconstexpr T\
    \ LIMMAX = std::numeric_limits<T>::max();\ntemplate<typename T>\nconstexpr T INF\
    \ = (LIMMAX<T> - 1) / 2;\ntemplate<typename T>\nconstexpr T PI = T{3.141592653589793238462643383279502884};\n\
...
documentation_of: src/misc/common/constants.hpp
layout: document
redirect_from:
- /library/src/misc/common/constants.hpp
- /library/src/misc/common/constants.hpp.html
