...
data:
  ...
  bundledCode: "#line 2 \"src/misc/common/type_alias.hpp\"\n#include <bits/stdc++.h>\n\
    ...
    \ = std::priority_queue<T, Vec<T>, Gt<T>>;\n#pragma endregion\n#line 3 \"src/misc/common/fixpoint.hpp\"\
  ...
  verifiedWith: []
documentation_of: src/misc/common/fixpoint.hpp
layout: document
redirect_from:
- /library/src/misc/common/fixpoint.hpp
- /library/src/misc/common/fixpoint.hpp.html
