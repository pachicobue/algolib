...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \ ri] = m_nodes[i].sons;\n        return subNodes(li) + Vec<Node>{m_nodes[i]}\
    \ + subNodes(ri);\n    }\nprivate:\n    int isRight(int i)\n    {\n        return\
    \ m_nodes[i].pi != -1 and m_nodes[m_nodes[i].pi].ri == i;\n    }\n    int isLeft(int\
    \ i)\n    {\n        return m_nodes[i].pi != -1 and m_nodes[m_nodes[i].pi].li\
  ...
  requiredBy: []
  timestamp: '2021-05-23 15:47:09+09:00'
