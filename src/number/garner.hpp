...
{
public:
    template<typename mint, typename mint1, typename mint2> static mint restore_mod(const mint1& x1, const mint2& x2)
    {
    ...
    template<typename mint1, typename mint2> static i64 restore_i64(const mint1& x1, const mint2& x2)
    {
    ...
    template<typename mint1, typename mint2, typename mint3> static i64 restore_i64(const mint1& x1, const mint2& x2, const mint3& x3)
    {
        constexpr u32 m1        = mint1::mod();
        constexpr u32 m2        = mint2::mod();
...
private:
    template<typename mint1, typename mint2> static Pair<mint1, mint2> coeff(const mint1& x1, const mint2& x2)
    {
        constexpr auto m1      = mint1::mod();
