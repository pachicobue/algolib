...
public:
     ...
     * @return mint 最小のx
     */
    template <typename mint, typename mint1, typename mint2> static constexpr auto restoreMod(const mint1& x1, const mint2& x2) -> mint {
    ...
    static constexpr auto restoreMod(const mint1& x1, const mint2& x2, const mint3& x3) -> mint {
     ...
     * @return i64 絶対値最小のx
     */
    template <typename mint1, typename mint2> static constexpr auto restoreInt(const mint1& x1, const mint2& x2) -> i64 {
        const u64 m1 = mint1::mod(), m2 = mint2::mod();
        const auto [y0, y1] = coeff(x1, x2);
    ...
    static constexpr auto restoreInt(const mint1& x1, const mint2& x2, const mint3& x3) -> i64 {
...
private:
    template <typename mint1, typename mint2> static constexpr auto coeff(const mint1& x1, const mint2& x2) -> Pair<i64, i64> {
        const u64 m1 = mint1::mod();
    ...
    template <typename mint1, typename mint2, typename mint3>
    static constexpr auto coeff(const mint1& x1, const mint2& x2, const mint3& x3) -> Tup<i64, i64, i64> {
        const u64 m1 = mint1::mod(), m2 = mint2::mod();
        const mint2 m1_inv = mint2(m1).inv();
