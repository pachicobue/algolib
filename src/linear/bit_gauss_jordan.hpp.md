...
data:
  ...
  verifiedWith: []
documentation_of: src/linear/bit_gauss_jordan.hpp
layout: document
redirect_from:
- /library/src/linear/bit_gauss_jordan.hpp
- /library/src/linear/bit_gauss_jordan.hpp.html
