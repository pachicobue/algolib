...
data:
  ...
  code: "#pragma once\n#include \"../misc/common.hpp\"\ntemplate<int D>\nclass BitBases\n\
    ...
    \    }\n    const Vec<T>& bases() const\n    {\n        return m_bases;\n    }\n\
    \    int rank() const\n    {\n        return m_bases.size();\n    }\n    T operator[](int\
    \ i) const\n    {\n        return m_spans[i];\n    }\n    Pair<bool, T> decomp(T\
    \ v) const\n    {\n        T mask = 0;\n        for (int j : irange(D - 1, -1,\
    ...
    \ m_masks;  // m_bases[i]\u304Cm_spans\u306E\u3046\u3061\u4F55\u756A\u76EE\u3067\
    \u51FA\u6765\u3066\u3044\u308B\u304B\n    Arr<int, D> m_d2vis;\n};\n"
  dependsOn:
  - src/misc/common.hpp
...
layout: document
redirect_from:
- /library/src/linear/bit_bases.hpp
- /library/src/linear/bit_bases.hpp.html
