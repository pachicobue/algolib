...
template<typename T = i64> class LiChaoTree
{
    ...
    static bool comp(const Opt<L>& l1, const Opt<L>& l2, i64 x)  // l1(x) < l2(x)
    {
...
public:
     ...
     * @param x_right 
     */
    void addSeg(const L& line, i64 x_left, i64 x_right)
    {
