...
data:
  ...
  bundledCode: "#include <bits/stdc++.h>\n#pragma region Macros\n#pragma endregion\n\
    ...
    \ auto ftable = factorTable(sup);\n    Vec<u32> ps;\n    for (u32 p = 2; p < sup;\
    \ p++) {\n        if (ftable[p] == p) { ps.push_back(p); }\n    }\n    return\
    \ ps;\n}\ntemplate<typename T>\nVec<T> divisorsMoebius(const Vec<T>& xs, bool\
...
layout: document
redirect_from:
- /library/src/math/gcd_convolution.hpp
- /library/src/math/gcd_convolution.hpp.html
