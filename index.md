...
data:
  ...
  - name: src/misc/common/print
    ...
    - icon: ':warning:'
      path: src/misc/common/print/map.hpp
      title: src/misc/common/print/map.hpp
    - icon: ':warning:'
      path: src/misc/common/print/multimap.hpp
      title: src/misc/common/print/multimap.hpp
    - icon: ':warning:'
    ...
    - icon: ':warning:'
      path: src/misc/common/print/queue.hpp
      title: src/misc/common/print/queue.hpp
    - icon: ':warning:'
    ...
    - icon: ':warning:'
      path: src/misc/common/print/unordered_map.hpp
      title: src/misc/common/print/unordered_map.hpp
    - icon: ':warning:'
      path: src/misc/common/print/unordered_multimap.hpp
      title: src/misc/common/print/unordered_multimap.hpp
    - icon: ':warning:'
  ...
  - name: verifications/misc/common
    pages:
    - icon: ':heavy_check_mark:'
